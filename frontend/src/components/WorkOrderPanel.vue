    ...
    <div class="two-column work-layout">
      <div class="panel">
        ...
        <div class="work-order-filters sticky-filters">
          ...
          <select :value="workOrderStatusFilter" class="control-input" @change="emit('update:workOrderStatusFilter', $event.target.value)"><option value="">全部状态</option><option>待确认</option><option>处理中</option><option>已确认</option><option>已完成</option><option>已关闭</option></select>
        ...
        <div v-if="selectedWorkOrder">
          ...
          <div v-else class="work-order-detail">
            ...
            <div class="form-stack">
              <label>状态<select v-model="feedback.status" class="control-input" :disabled="showArchived"><option>待确认</option><option>已确认</option><option>处理中</option><option>已完成</option><option>已关闭</option></select></label>
